 ...
 * 
 */
package com.yueny.rapid.lang.mask.internals.tacitly;
...
public class DefaultWatchServiceConfiguration implements IWatchServiceConfiguration {
	...
	/* (non-Javadoc)
	 * @see com.yueny.rapid.lang.mask.spi.IWatchServiceConfiguration#getEmailFields()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.yueny.rapid.lang.mask.spi.IWatchServiceConfiguration#getMaskFields()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.yueny.rapid.lang.mask.spi.IWatchServiceConfiguration#isBizMonitor()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.yueny.rapid.lang.mask.spi.IWatchServiceConfiguration#load()
	 */
	@Override
	public boolean load(){
